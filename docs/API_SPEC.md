...
| `settings.locationRevealIntervalMinutes` | integer (int32)                             | O    | 위치 공개 주기 (최소 1분)      |
...
| 케이스                          | title                 | detail                                              |
| ------------------------------- | --------------------- | --------------------------------------------------- |
| 감옥이 플레이그라운드 밖에 위치 | 감옥 영역 벗어남       | `감옥은 플레이그라운드 내부에 완전히 포함되어야 합니다.`    |
| 게임이 대기 중이 아닌 경우      | 대기 중인 게임이 아님  | `대기 중인 게임에서만 설정을 변경할 수 있습니다.`   |

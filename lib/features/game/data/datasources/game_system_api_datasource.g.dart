...
class _GameSystemApi implements GameSystemApi {
  _GameSystemApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<ArrestResponseModel> arrest(
    ...
    final _data = body;
    final _options = _setStreamType<ArrestResponseModel>(
    ...
    late ArrestResponseModel _value;
    try {
      _value = ArrestResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<GameAreaModel> getArea(int gameId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
